...
export async function createAccessToken (req: Request, res: Response, _next: NextFunction): Promise<void> {
...
export async function deleteUser (req: Request, res: Response, _next: NextFunction): Promise<void> {
...
export async function requestPasswordResetEmail (req: Request, res: Response, _next: NextFunction): Promise<void> {
